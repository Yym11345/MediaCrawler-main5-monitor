...
# Browser profile root. Each platform gets an independent Playwright persistent profile folder.
BROWSER_PROFILE_ROOT = os.getenv("BROWSER_PROFILE_ROOT", "browser_data")
...
# Monitor dashboard storage backend. Keep postgres as default; set MONITOR_DB_TYPE=sqlite for lightweight local use.
MONITOR_DB_TYPE = os.getenv("MONITOR_DB_TYPE", "postgres")
...
# Internal fallback for crawled videos/posts when no per-run limit is exposed in the UI.
CRAWLER_MAX_NOTES_COUNT = 1000000
