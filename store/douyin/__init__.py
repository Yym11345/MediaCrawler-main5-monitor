...
def _pick_douyin_fans(user_info: Dict):
    """Prefer the profile display follower count before fallback counters."""
    for key in ("mplatform_followers_count", "follower_count", "max_follower_count"):
...
async def update_dy_aweme_comment(aweme_id: str, comment_item: Dict):
    ...
    if str(aweme_id) != str(comment_aweme_id):
...
async def save_creator(user_id: str, creator: Dict):
    ...
    local_db_item = {
        ...
        "fans": _pick_douyin_fans(user_info),
